...
const albumsList = [ 
    ...
    {"albumName": "The Land Is Inhospitable and So Are We", "artistName": "Mitski"},
    {"albumName": "Maps", "artistName": "billy woods & Kenny Segal"},
    ...
    {"albumName": "The Rise and Fall of a Midwest Princess", "artistName": "Chappell Roan"},
    ...
    {"albumName": "My Back Was A Bridge For You To Cross", "artistName": "ANOHNI and the Johnsons"},
    {"albumName": "That! Feels Good!", "artistName": "Jessie Ware"},
    {"albumName": "SCARING THE HOES", "artistName": "JPEGMAFIA & Danny Brown"},
    {"albumName": "The Age of Pleasure", "artistName": "Janelle Monáe"},
    {"albumName": "Did you know that there's a tunnel under Ocean Blvd", "artistName": "Lana Del Rey"},
    {"albumName": "Gumbo", "artistName": "Young Nudy"},
    {"albumName": "PARANOÏA, ANGELS, TRUE LOVE", "artistName": "Christine and the Queens"},
    {"albumName": "Gag Order", "artistName": "Kesha"},
    {"albumName": "Weathervanes", "artistName": "Jason Isbell and the 400 Unit"},
    {"albumName": "Fountain Baby", "artistName": "Amaarae"},
    {"albumName": "Rat Saw God", "artistName": "Wednesday"},
    {"albumName": "Desire, I Want To Turn Into You", "artistName": "Caroline Polachek"},
    {"albumName": "Red Moon In Venus", "artistName": "Kali Uchis"},
    {"albumName": "Endless Summer Vacation", "artistName": "Miley Cyrus"},
    {"albumName": "Dogsbody", "artistName": "Model/Actriz"},
    {"albumName": "nadie sabe lo que va a pasar mañana", "artistName": "Bad Bunny"},
    {"albumName": "Get Up", "artistName": "NewJeans"},
    {"albumName": "Something To Give Each Other", "artistName": "Troye Sivan"},
    {"albumName": "For All The Dogs", "artistName": "Drake"},
    {"albumName": "Everyone's Crushed", "artistName": "Water From Your Eyes"},
    {"albumName": "Work Of Art", "artistName": "Asake"},
    {"albumName": "KAYTRAMINÉ", "artistName": "KAYTRAMINÉ"},
    {"albumName": "Ganger", "artistName": "Veeze"},
    {"albumName": "Why Does the Earth Give Us People to Love?", "artistName": "Kara Jackson"},
    ...
    {"albumName": "Mr. Morale & The Big Steppers", "artistName": "Kendrick Lamar"},
    ...
    {"albumName": "Traumazine", "artistName": "Megan Thee Stallion"},
    {"albumName": "Big Time", "artistName": "Angel Olsen"},
    {"albumName": "RAMONA PARK BROKE MY HEART", "artistName": "Vince Staples"},
    ...
    {"albumName": "American Heartbreak", "artistName": "Zach Bryan"},
    {"albumName": "Skinty Fia", "artistName": "Fontaines D.C."},
    {"albumName": "Dragon New Warm Mountain I Believe In You", "artistName": "Big Thief"},
    ...
    {"albumName": "Subaru Boys: FINAL HEAVEN", "artistName": "Cruel Santino"},
    {"albumName": "Headful of Sugar", "artistName": "Sunflower Bean"},
    {"albumName": "Sometimes, Forever", "artistName": "Soccer Mommy"},
    {"albumName": "Bien o Mal", "artistName": "Trueno"},
    {"albumName": "emails i can't send", "artistName": "Sabrina Carpenter"},
    {"albumName": "MUNA", "artistName": "MUNA"},
    {"albumName": "New Jeans", "artistName": "NewJeans"},
    {"albumName": "Laughing so Hard, it Hurts", "artistName": "MAVI"},
    ...
    {"albumName": "CALL ME IF YOU GET LOST", "artistName": "Tyler, The Creator"},
    ...
    {"albumName": "to hell with it", "artistName": "PinkPantheress"},
    {"albumName": "Reckless", "artistName": "Morgan Wade"},
    {"albumName": "Hall of Fame", "artistName": "Polo G"},
    {"albumName": "Happier Than Ever", "artistName": "Billie Eilish"},
    {"albumName": "HEY WHAT", "artistName": "Low"},
    {"albumName": "If Orange Was A Place", "artistName": "Tems"},
    {"albumName": "If I Can't Have Love, I Want Power", "artistName": "Halsey"},
    {"albumName": "Collapsed In Sunbeams", "artistName": "Arlo Parks"},
    {"albumName": "Gold-Diggers Sound", "artistName": "Leon Bridges"},
    ...
    {"albumName": "An Evening with Silk Sonic", "artistName": "Silk Sonic"},
    {"albumName": "Sometimes I Might Be Introvert", "artistName": "Little Simz"},
    {"albumName": "Shiesty Season", "artistName": "Pooh Shiesty"},
    {"albumName": "Stand for Myself", "artistName": "Yola"},
    {"albumName": "Don't Go Tellin' Your Momma", "artistName": "Topaz Jones"},
    {"albumName": "Medicine at Midnight", "artistName": "Foo Fighters"},
    {"albumName": "Remember Her Name", "artistName": "Mickey Guyton"},
    {"albumName": "Let Me Do One More", "artistName": "illuminati hotties"},
    {"albumName": "LYKE MIKE", "artistName": "Myke Towers"},
    {"albumName": "Senjutsu", "artistName": "Iron Maiden"},
    {"albumName": "Bo Jackson", "artistName": "Boldy James & The Alchemist"},
    {"albumName": "The Chaos Chapter: FIGHT OR ESCAPE", "artistName": "TOMORROW X TOGETHER"},
    {"albumName": "Timelezz", "artistName": "Jhayco"},
    {"albumName": "Certified Lover Boy", "artistName": "Drake"},
    {"albumName": "The Horses and the Hounds", "artistName": "James McMurtry"},
    {"albumName": "Daddy's Home", "artistName": "St. Vincent"},
    {"albumName": "folklore", "artistName": "Taylor Swift"},
    {"albumName": "Fetch the Bolt Cutters", "artistName": "Fiona Apple"},
    {"albumName": "YHLQMDLG", "artistName": "Bad Bunny"},
    {"albumName": "Rough and Rowdy Ways", "artistName": "Bob Dylan"},
    ...
    {"albumName": "TO LOVE IS TO LIVE", "artistName": "Jehnny Beth"},
    {"albumName": "Good News", "artistName": "Megan Thee Stallion"},
    {"albumName": "Reunions", "artistName": "Jason Isbell and the 400 Unit"},
    {"albumName": "Shamir", "artistName": "Shamir"},
    {"albumName": "Sixteen Oceans", "artistName": "Four Tet"},
    {"albumName": "Petals for Armor", "artistName": "Hayley Williams"},
    ...
    {"albumName": "Got to Be Tough", "artistName": "Toots & The Maytals"},
    {"albumName": "Traditional Techniques", "artistName": "Stephen Malkmus"},
    ...
    {"albumName": "The Price of Tea in China", "artistName": "Boldy James & The Alchemist"},
    {"albumName": "Good Souls Better Angels", "artistName": "Lucinda Williams"},
